...
{
public:
	CollisionProcessing(b2World *world, VERenderImplementation *render) : Test(world, render)
	{
		// Ground body
		{
			b2EdgeShape shape;
	...
	static Test* Create(b2World *world, VERenderImplementation *render) 
	{
		return new CollisionProcessing(world, render);
	}
};
